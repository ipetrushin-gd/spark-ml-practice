...
import com.petproject.spark_ml.tweets_classification.FeaturesExtractionFromRawTweet.StructuredTweet
...
class TextToStructuredDataSpec extends FunSpec with SparkSessionCreator with DatasetComparer {
  ...
  describe("A tweets") {
    describe("when tweets are real") {
      ...
      val expected = Seq(
        StructuredTweet("RT @emy_wng: Thanks Bloomberg for featuring @Ripple and #MoneyTap! https://t.co/WDuJnD1tq4", "en", 1),
        StructuredTweet("$btc #bitcoin #cryptolife #cryptofamily Good morning, Bitcoin has good support now, he might not instantly jump up,… https://t.co/ok8vMxuE17", "en", 0),
        StructuredTweet("Earn bitcoin on a daily basis!\n1. Follow @slidecoin\n2. Complete instructions in pinned tweet", "en", 0),
        StructuredTweet("RT @nodepower_eu: Great YouTube video review about #Node made by Getting Started with Crypto channel.\n\nThank you for such a profound ana…", "en", 1),
        StructuredTweet("RT @Digitalnaiv: Fundstück: Smart Package: #Blockchain Patent von #Walmart -  via @CIOKurator  https://t.co/pt18IRsjee #Retail #Handel", "de", 1),
        StructuredTweet("#Kepler is one of bigger #AI #ICO still active (link: https://t.co/aUXxAzChbr) https://t.co/gE5c4A4ID8", "en", 0),
        StructuredTweet("@evenjangle ATMS is the perfect cryptocurrency.", "en", 0),
        StructuredTweet(".@unit4@unit42_intel はここ6ヵ月で、#仮想通貨 の #マイニング を最終目的とした攻撃活動数の大幅増加を観察。何が攻撃者からの大幅な変化を促進し、業界の著しい動向を生み出しているのでしょうか? 最も多く#マイ… https://t.co/qv2hEfGFA7", "ja", 0),
        StructuredTweet("RT @eGoldgg: If you need to understand the advantages that Blockchain technology can bring to the eSports betting sector - watch Mario Ovch…", "en", 1),
        StructuredTweet("ネムコイン(XEM)とは？特徴・仕組み・今後について徹底解説！  仮想通貨メディアBTC Feedビットコインフィード https://t.co/qSPi7jZxAk", "ja", 0),
        StructuredTweet("9 Stocks to Buy Instead of Bitcoin | InvestorPlace https://t.co/UlJ2GuglpE #markets… https://t.co/KdmrRuJple", "en", 0),
        StructuredTweet("RT @Kora_Network: #Kora was featured on the Crypto Knights Podcast! Check it out. #financialinclusion #blockchain4good\n\nhttps://t.co/2SBwz…", "en", 1)
      ).toDS
    ...
    describe("with isRetweet field") {
      ...
      val expected = Seq(
        StructuredTweet("RT @emy_wng: Thanks Bloomberg for featuring @Ripple and #MoneyTap! https://t.co/WDuJnD1tq4", "en", 1),
        StructuredTweet("RT @emy_wng: Thanks Bloomberg for featuring @Ripple and #MoneyTap! https://t.co/WDuJnD1tq4", "en", 0)
      ).toDS
    ...
    describe("with language field") {
      ...
      val expected = Seq(
        StructuredTweet("RT @emy_wng: Thanks Bloomberg for featuring @Ripple and #MoneyTap! https://t.co/WDuJnD1tq4", "en", 1),
        StructuredTweet("RT @emy_wng: Thanks Bloomberg for featuring @Ripple and #MoneyTap! https://t.co/WDuJnD1tq4", "de", 1),
        StructuredTweet("RT @emy_wng: Thanks Bloomberg for featuring @Ripple and #MoneyTap! https://t.co/WDuJnD1tq4", "jp", 1),
        StructuredTweet("RT @emy_wng: Thanks Bloomberg for featuring @Ripple and #MoneyTap! https://t.co/WDuJnD1tq4", "fr", 1),
        StructuredTweet("RT @emy_wng: Thanks Bloomberg for featuring @Ripple and #MoneyTap! https://t.co/WDuJnD1tq4", "ru", 0)
      ).toDS
    ...
    describe(" with new-line symbols in text") {
      ...
      val expected = Seq(
        ...
        StructuredTweet("$btc #bitcoin #cryptolife\n\n#cryptofamily Good morning, Bitcoin has good support now,\nhe might not instantly jump up,…\nhttps://t.co/ok8vMxuE17", "en", 0),
        StructuredTweet("Earn bitcoin on a daily basis!\n1. Follow @slidecoin\n2. Complete instructions in pinned tweet", "en", 0)
      ).toDS
    ...
    describe("with 'und' as language marker") {
      ...
      val expected = Seq(
        StructuredTweet("RT @emy_wng: Thanks Bloomberg for featuring @Ripple and #MoneyTap! https://t.co/WDuJnD1tq4", "??", 1)
      ).toDS
